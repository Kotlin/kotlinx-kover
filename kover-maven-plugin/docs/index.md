...
## Quickstart
To use Kover coverage measurement it is necessary to add plugin `org.jetbrains.kotlinx:kover-maven-plugin:0.9.9` to build configuration in `pom.xml` and create executions for used goals.
