...
* When submitting a bug report:
  ...
  * By default, we assume that your problem reproduces in Kotlin/JVM project with using the IntelliJ Coverage Engine. Please, mention if the problem is
    specific to Kotlin Multi-Platform/Android or JaCoCo. 
