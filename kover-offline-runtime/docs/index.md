...
You can declare a dependency on Kover Features using following coordinates: `org.jetbrains.kotlinx:kover-features-jvm:0.9.6`.
...
dependencies {
    runtimeOnly("org.jetbrains.kotlinx:kover-offline-runtime:0.9.6")
    add("koverCli", "org.jetbrains.kotlinx:kover-cli:0.9.6")
